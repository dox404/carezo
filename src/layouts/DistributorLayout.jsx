    ...
    <div className="min-h-screen bg-dark-950 flex">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        <div className="lg:hidden flex items-center gap-3 px-4 h-14 bg-dark-900 border-b border-dark-700 sticky top-0 z-10">
          <button onClick={() => setSidebarOpen(true)} className="p-1.5 text-dark-300"><Menu size={20} /></button>
          <span className="font-display font-bold text-white">Carezo Distributor</span>
        </div>
