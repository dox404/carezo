...
import { dealerLogin } from '../../api/index';
...
export default function DealerLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await dealerLogin(form);
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[30rem] h-[20rem] sm:w-[40rem] bg-indigo-500/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-0 right-0 w-[20rem] h-[20rem] sm:w-[30rem] sm:h-[30rem] bg-blue-500/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="w-full max-w-sm sm:max-w-md relative animate-fade-up z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-indigo-400 to-indigo-600 rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-5 shadow-xl shadow-indigo-600/30 transition-transform hover:scale-105 duration-300">
            <Shield size={36} className="text-white" />
          </div>
          <h1 className="font-bold text-white text-3xl sm:text-4xl tracking-tight">Carezo</h1>
          <p className="text-zinc-400 text-sm mt-2 font-medium">Dealer Portal</p>
        </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="you@dealershop.com"
                  value={form.email} 
